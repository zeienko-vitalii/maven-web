    ...
    <div class="search-box">
        ...
        <div class="search-fields">
            ...
            <form action="/Controller" method="post">
                <!-- Departure station -->
                <input type="text" name="departure_station" id="departure_station" placeholder="From" required/>

                <!-- Arrival station -->
                <input type="text" name="arrival_station" id="arrival_station" placeholder="To" required/>
